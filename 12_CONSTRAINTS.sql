...
grant all privileges on user_db.* to 'ohgiraffes'@'%';
...
-- CONSTRAINTS
-- 제약조건, 테이블에 데이터가 입력되거나 수정할 떄의 규칙을 정의한다.
...
values (1, 'user01', 'pass01', '홍길동', '남', '010-1234-5678', 'hon1235@gmail.com'),
...
-- [23000][1062] Duplicate entry '1' for key 'user_primarykey.user_no' 발생
insert into user_unique
    (user_no, user_id, user_pwd, user_name, gender, phone, email)
values (1, 'user01', 'pass01', '홍길동', '남', '010-1234-5678', 'hon1235@gmail.com'),
       (2, 'user02', 'pass02', '유관순', '여', '010-7777-7777', 'yu1234@gmail.com');

-- PRIMARY KEY
-- 테이블에서 한 행의 정보를 찾기 위해 사용할 컬럼을 의미
-- NOT NULL + UNIQUE 제약조건을 의미
-- 한 테이블당 한개만 설정 할 수 있다.
...
values (1, 'user01', 'pass01', '홍길동', '남', '010-1234-5678', 'hon1235@gmail.com', 10),
       (2, 'user02', 'pass02', '유관순', '여', '010-7777-7777', 'yu1234@gmail.com', 20);
select *
